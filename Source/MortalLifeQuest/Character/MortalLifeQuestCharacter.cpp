...
AMortalLifeQuestCharacter::AMortalLifeQuestCharacter()
{
...
void AMortalLifeQuestCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		// Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &AMortalLifeQuestCharacter::Move);

		// Looking
		EnhancedInputComponent->BindAction(LookAction, ETriggerEvent::Triggered, this, &AMortalLifeQuestCharacter::Look);
	}
	else
	{
...
void AMortalLifeQuestCharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void AMortalLifeQuestCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
